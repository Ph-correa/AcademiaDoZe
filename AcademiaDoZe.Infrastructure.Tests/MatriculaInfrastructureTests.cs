...
public class MatriculaInfrastructureTests : TestBase
{
    ...
    Arquivo? laudo = null)
    {
        ...
        id: 0, aluno: aluno, plano: plano, dataInicio: inicio, objetivo: "Pedro Henrique Correa", restricoesMedicas: restricoes, laudoMedico: laudo, observacoesRestricoes: obsRestricao
        );
    ...
    public async Task Matricula_Atualizar_LancaExcecaoQuandoInexistente()
    {
        ...
        objetivo: "Pedro Henrique Correa",
